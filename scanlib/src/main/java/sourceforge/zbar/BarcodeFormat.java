...
public class BarcodeFormat {
    ...
    public static final List<BarcodeFormat> CUSTOM_FORMATS = new ArrayList<BarcodeFormat>();
    ...
    static {
        CUSTOM_FORMATS.add(BarcodeFormat.QRCODE);
        CUSTOM_FORMATS.add(BarcodeFormat.CODE128);
    }
